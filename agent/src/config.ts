...
export const config = {
  ...
  codexModel: parseOptional(process.env.RUNTIME_CODEX_MODEL) ?? "gpt-5.1-codex-mini",
  codexTimeoutSeconds: Math.max(30, Math.floor(parseNumber(process.env.RUNTIME_AGENTIC_CODEX_TIMEOUT_SECONDS, 300))),
